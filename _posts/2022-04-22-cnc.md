...
#### Setting up your file in VCarf Pro
...
Sometimes when you import a file lines disconnect. You can fix it in the VCarf.
...
Feed rate - 50 - 60 mm for wood with 2 flute end mill. Smaller diameter -> Go slower. Check with Henk and other presets (trial and error) more flute; go slower (not completely sure).

Plunge rate - Speed of going down, always on 20. If milling foam (easier for mill) 100 - 120 mm per second.

4. Peck drilling - Doing down in steps. (don’t need to use) (look up when to use)

5. Dwell at the bottom of each drill pass - no clue, need to look up.
...
Offset (square spiral - not beneficial for circle) or raster (side by side). 
...
Pocket allowance - How tightly the mill moves. (To make thing fit loosely or tightly)
...
When changing a file - Always calculate again! Never change anything after checking. Breathe, don’t hurry. 
...
From left to right: Mill - Collet - Nut
...
27. Press page up ! No other button !
...
Stay close to the spacebar - if anything goes wrong: the mill will stop when you hit spacebar. 
